...
data_continuous_phenotype <- read.csv('/Users/ghosha/Documents/VSCode Projects/pager/data/sample_data_cont.csv')
...
write.csv(pager_encoded_genotype, file = '/Users/ghosha/Documents/VSCode Projects/pager/data/sample_data_cont_pager_encoded.csv', row.names = FALSE)

# Write the missing genotypes dataframe to a csv file
write.csv(result[[2]], file = '/Users/ghosha/Documents/VSCode Projects/pager/data/missing_genotypes.csv', row.names = FALSE)
```

## STEP 4 - PAGER encode Dataset 2 - Discrete Phenotype
```{r setup, include=TRUE}
# Read the data from the csv file
data_continuous_phenotype <- read.csv('/Users/ghosha/Documents/VSCode Projects/pager/data/sample_data_disc.csv')
...
# Write the PAGER encoded data to a csv file
write.csv(pager_encoded_genotype, file = '/Users/ghosha/Documents/VSCode Projects/pager/data/sample_data_disc_pager_encoded.csv', row.names = FALSE)
