...
case_control_ratio_values = [0.25, 0.5]
...
results_df = pd.DataFrame(columns=["Iteration", "Num_Samples", "Case_Control_Ratio", "MAFA", "PEN_DIFF", "additive_pvalue","EDGE_pvalue", "PAGER_pvalue", "EDGE_TIME", "PAGER_TIME"])
