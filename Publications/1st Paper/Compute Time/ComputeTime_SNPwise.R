...
setwd("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/all simulation tests/single_snp_discrete/Figures/ComputeTime")

# Import SNPwise files
rep1 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_1.csv")
rep2 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_2.csv")
rep3 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_3.csv")
rep4 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_4.csv")
rep5 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_5.csv")
rep6 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_6.csv")
rep7 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_7.csv")
rep8 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_8.csv")
rep9 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_9.csv")
rep10 <- read.csv("~/Library/CloudStorage/Box-Box/CedarsSinai/AutoQTL/EDGE/Results/For manuscript/cpu vs gpu/snpwise/replicate_10.csv")
