...
the training dataset for all the inheritence patterns and discrete phenotype."""
...
results_df.to_csv("/path/to/save/additive_discrete_simulations.csv", index=False)
...
# Create an empty DataFrame to store the results
results_df = pd.DataFrame(columns=["Iteration", "Num_Samples", "Case_Control_Ratio", "MAFA", "PEN_DIFF", "EDGE_VALUE",
             "PAGER_VALUE_0", "PAGER_VALUE_1", "PAGER_VALUE_2", "Original_pvalue", "INHERENT_pvalue", "EDGE_pvalue", "EDGE_TIME", "PAGER_CPU_TIME", "PAGER_GPU_TIME"])
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/dominant_discrete_simulations.csv", index=False)
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/heterosis_discrete_simulations.csv", index=False)
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/overdominant_discrete_simulations.csv", index=False)
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/recessive_discrete_simulations.csv", index=False)
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/subadditive_discrete_simulations.csv", index=False)
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/superadditive_discrete_simulations.csv", index=False)
...
# Save the results DataFrame to a CSV file
results_df.to_csv("/path/to/save/underdominant_discrete_simulations.csv", index=False)
