...
1. Generate single SNP dataset with continuous phenotype using BAMs.
...
case_control_ratio_values = 0.25 # using a default case control ratio
        ...
        for num_samples_setting in num_samples:
            for PEN_DIFF_setting in PEN_DIFF_values:
                for MAFA_setting in MAFA_values:
                    ...
                    ab1, ab2 = work_group[2] # decides the inheritance pattern of the SNPs (0 - recessive, 1 - subadditive, 2 - additive, 3 - superadditive, 4 - dominant, 5 - heterosis, 6 - overdominant, 7 - underdominant, 8 - null )
